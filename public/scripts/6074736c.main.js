...
define("cryptojs.hmac.sha256", function(){});

(function() {
  define('core/api/request',['core/api/exception', 'config', 'cryptojs.hmac.sha256'], function(ApiException, app_config) {
    var ApiRequest;
    ...
    Api = (function() {
      ...
      Api._handleResponse = function(response, resolver) {
        if (response.data == null) {
          ...
          return resolver.reject(new ApiException("api.error", response.errors));
        } else {
...
(function() {
  ...
  define('core/session',['app', 'when', "core/session/providers", "core/api", 'cryptojs.pbkdf2', 'cryptojs.hmac.sha256'], function(app, When, SessionProviders, Api) {
      ...
      tryLogin.then(function(response) {
        ...
        if ((response.salt1 != null) && (response.salt2 != null)) {
          ...
          check_session.then((function(response) {
            return defer.resolver.resolve(new Session(auth, {}, new provider));
          }));
